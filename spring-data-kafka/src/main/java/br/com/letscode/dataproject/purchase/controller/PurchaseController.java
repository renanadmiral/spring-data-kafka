...
import br.com.letscode.dataproject.purchase.kafka.SendKafkaMessage;
...
public class PurchaseController {
   ...
   private final SendKafkaMessage kafkaMessage;
    ...
    @PostMapping("/queue")
    public RequestPurchaseDTO sendPuchaseToQueue(@RequestBody RequestPurchaseDTO purchase) {
        return kafkaMessage.sendMessage(purchase);
    }
}
